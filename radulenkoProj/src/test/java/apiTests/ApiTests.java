...
public class ApiTests {
    ...
    public void getAllPostsByUserTest(){
        ...
        PostDto[] expectedResult = {
                PostDto.builder().title("test1").body("test body2").select1("All Users")
                        .uniquePost("no").author(AuthorDto.builder().username("autoapi").build())
                        .isVisitorOwner(false)
                        .build(),
                PostDto.builder().title("test").body("test body").select1("All Users")
                        .uniquePost("no").author(AuthorDto.builder().username("autoapi1").build())
                        .isVisitorOwner(false)
                        .build()
        };
